                        ...
                        <table class="table table-responsive " >
                            ...
                            <?php if (count($edit) > 0) : ?>
                                <?php foreach ($edit as $edit): ?>
                                    <tr >
                                        <td>
                                            <?php echo form_open('PublicMarket/ViewPublicMarketEditSubmitForm') ?>
                                            <p><input type="hidden" size="80" id="kwd" name="kwd" value="<?= $edit['kwd'] ?>"/>    
                                                <span title="Συμπληρώστε τη Λαϊκή Αγορά">
                                                    <input type="text" name="name" id="name" placeholder="Λαϊκή Αγορά" value="<?= $edit['name'] ?>"  />
                                                </span>
                                        </td>
                                    </tr>
