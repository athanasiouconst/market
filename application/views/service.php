...
<html lang="en">
<head>
<title>Trade Market a Corporate Business Category Flat Bootstrap Responsive Website Template | Customer Service :: w3layouts</title>
<!-- for-mobile-apps -->
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<nav class="wthree_nav">
						<ul class="nav navbar-nav nav_1">
							...
							<li class="act"><a href="service.html">Customer Service</a></li>
...
<!-- services -->
	<div class="services">
		<div class="container">
			...
			<div class="col-md-4 w3layouts_services_right">
				<img src="images/48.jpg" alt=" " class="img-responsive" />
			</div>
			<div class="col-md-4 w3layouts_services_left">
				<div class="w3_customer_email">
					<div class="w3_customer_email_left">
						<i class="fa fa-envelope" aria-hidden="true"></i>
					</div>
					<div class="w3_customer_email_right">
						<h4>Email Us</h4>
						<a href="mailto:trademarket@example.com">trademarket@example.com</a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="w3_customer_email">
			...
			<div class="col-md-4 w3layouts_services_left">
				...
				<div class="w3_customer_email">
					...
					<div class="w3_customer_email_right">
						<h4>Helpdesk</h4>
						<p>trade market securities Ltd New York City, USA.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
