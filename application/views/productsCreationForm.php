                ...
                <div class="tg-wrap">
                    ...
                    <div class="w3_equity_market_analysis_grid_sub">
                        <table class="table table-responsive " >
                            ...
                            <tr>
                                <td>
                                    <?php echo form_open('Products/CreateProducts') ?>    
                                    <span title="Συμπληρώστε την ονομασία του προϊόντος">
                                        <input type="text" name="proion" id="proion" placeholder="Προϊόν" value="<?php echo set_value('proion'); ?>"  />
                                    </span>
                                </td>
                            </tr>
                        </table>
