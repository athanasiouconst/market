                                        ...
                                        <tr class="tg-l509 important">
                                            <?php foreach ($fields as $field_name => $field_display): ?>
                                                <th <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
                                                    <?php
                                                    echo anchor("WorkingDays/ViewDays/$field_name/" .
                                        ...
                                        <?php foreach ($gen as $gen): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <?php
                                                    echo anchor("WorkingDays/ViewDaysEditForm/$gen->kwd", $edit, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
                                                    ?>
                                                    <?php echo anchor("WorkingDays/ViewDaysDelete/$gen->kwd", $delete, array('onClick' => "return confirm('Είστε σίγουρος για τη διαγραφή;;')")); ?>    
                                                </td>
                                            <?php endforeach; ?>
                                        </tr>
