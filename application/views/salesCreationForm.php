        ...
        <div class="col-md-12 w3_equity_market_analysis">
            <div class="w3_equity_market_analysis_grid">
                ...
                <div style="float: right;">
                    <a href="<?php echo base_url('Sales/ViewSalesCreationForm'); ?>" class="btn btn-info">ΠΡΟΣΘΗΚΗ ΠΩΛΗΣΗΣ</a>
                    <br><br>
                </div>
                <div class="tg-wrap">
                    <h3><i class="fa fa-exchange" aria-hidden="true"></i>ΠΩΛΗΣΕΙΣ</h3>
                    ...
                    <div class="w3_equity_market_analysis_grid_sub">
                        <table class="table table-responsive " >
                            ...
                            <?php echo form_open('Sales/CreateSales') ?>
                            <tr>  
                                <td>
                                    <p><span title="Συμπληρώστε την Ημερομηνία"></span>
                                    <div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input type="text" name="hmnia" id="hmnia" value="<?php echo set_value('hmnia'); ?>" placeholder="Ημερομηνία" >
                                        <span class="add-on"><i class="icon-remove"></i></span>
                                        <span class="add-on"><i class="icon-th"></i></span>
                                    </div>
                                    <input type="hidden" id="hmnia" value="<?php echo set_value('hmnia'); ?>" /><br/>
                            </td>
                            </tr>
                                ...
                                <td>
                                    <span title="Επιλέξτε τη Λαϊκή Αγορά">
                                        ...
                                        <select name='laikh' id='laikh' >
                                            <option value="-1">Επιλογή Λαϊκής</option>
                                            <?php if (isset($gens)): ?>
                                                <?php foreach ($gen as $gen): ?>
                                                    <option value="<?php echo $gen->kwd; ?>"><?php echo $gen->name; ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </span>
                                ...
                                <td>
                                    <span title="Επιλέξτε το προϊόν">
                                        ...
                                        <select name='proion' id='proion' >
                                            <option value="-1">Επιλογή Προϊόντος</option>
                                            <?php if (isset($gensProd)): ?>
                                                <?php foreach ($genProd as $genProd): ?>
                                                    <option value="<?php echo $genProd->kwd; ?>"><?php echo $genProd->proion; ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </span>
                            ...
                            <tr>  
                                <td>
                                    <span title="Συμπληρώστε την αρχική ποσότητα του προϊόντος">
                                        <input type="text" name="arx_posot" id="arx_posot" placeholder="Αρχική Ποσότητα Προϊόντος" value="<?php echo set_value('arx_posot'); ?>"  />
                                    </span>
                                </td>
                            </tr>
                            <tr>  
                                <td>
                                    <span title="Συμπληρώστε τη ποσότητα επιστροφής του προϊόντος">
                                        <input type="text" name="posot_epistr" id="posot_epistr" placeholder="Ποσότητα Επιστροφής Προϊόντος" value="<?php echo set_value('posot_epistr'); ?>"  />
                                    </span>
                                </td>
                            </tr>
                            <tr>  
                                <td>
                                    <span title="Συμπληρώστε τη ποσότητα πώλησης του προϊόντος">
                                        <input type="text" name="posot_pwlhs" id="posot_pwlhs" placeholder="Ποσότητα Πώλησης Προϊόντος" value="<?php echo set_value('posot_pwlhs'); ?>"  />
                                    </span>
                                </td>
                            </tr>
                            <tr>  
                                <td>
                                    <span title="Συμπληρώστε την αξία αγοράς του προϊόντος">
                                        <input type="text" name="ajia_agoras" id="ajia_agoras" placeholder="Αξία Αγοράς Προϊόντος" value="<?php echo set_value('ajia_agoras'); ?>"  />
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>  
                                <td>
                                    <span title="Συμπληρώστε το κόστος του προϊόντος">
                                        <input type="text" name="kostos" id="kostos" placeholder="Κόστος Προϊόντος" value="<?php echo set_value('kostos'); ?>"  />
                                    </span>
                                </td>
                            </tr>
