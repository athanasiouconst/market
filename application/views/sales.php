                                        ...
                                        <tr class="tg-l509 important">
                                            <?php foreach ($fields as $field_name => $field_display): ?>
                                                <th <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
                                                    <?php
                                                    echo anchor("Sales/ViewSales/$field_name/" .
                                        ...
                                        <?php foreach ($gen as $gen): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $aa = $gen->aa;
                                                    $edit = '<span title="' . $aa . '">Επεξεργασία</span>';
                                                    $delete = '<span title="' . $aa . '">Διαγραφή</span>';
                                                    ?>
                                                    <?php
                                                    echo anchor("Sales/ViewSalesEditForm/$gen->aa", $edit, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
                                                    ?>
                                                    <?php echo anchor("Sales/ViewSalesDelete/$gen->aa", $delete, array('onClick' => "return confirm('Είστε σίγουρος για τη διαγραφή;;')")); ?>    
                                                </td>
                                            <?php endforeach; ?>
                                        </tr>
                                        <tr><td colspan="12" class="tg-h2ie"></td></tr>
                                        <tr>

                                            <td colspan="12" class="tg-h2ie">
