                        ...
                        <table class="table table-responsive " >
                            ...
                            <?php if (count($edit) > 0) : ?>
                                <?php foreach ($edit as $edit): ?>
                                    <tr >
                                        <td>
                                            <?php echo form_open('Products/ViewProductsEditSubmitForm') ?>
                                            <p><input type="hidden" size="80" id="kwd" name="kwd" value="<?= $edit['kwd'] ?>"/>    
                                                <span title="Συμπληρώστε την ονομασία του προϊόντος">
                                                    <input type="text" name="proion" id="proion" placeholder="Ονομασία του προϊόντος" value="<?= $edit['proion'] ?>"  />
                                                </span>
                                        </td>
                                    </tr>
