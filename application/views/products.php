...
<div style="float: right;">
                            <a href="<?php echo base_url('Products/ViewProductsCreationForm'); ?>" class="btn btn-info">ΠΡΟΣΘΗΚΗ ΠΡΟΪΟΝΤΟΣ</a>
                            <br><br>
                        </div>
                <div class="tg-wrap">
                    <h3><i class="fa fa-exchange" aria-hidden="true"></i>ΠΡΟΪΟΝΤΑ ΛΑΪΚΗΣ ΑΓΟΡΑΣ</h3>
                                        ...
                                        <tr class="tg-l509 important">
                                            <?php foreach ($fields as $field_name => $field_display): ?>
                                                <th <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
                                                    <?php
                                                    echo anchor("Products/ViewProducts/$field_name/" .
                                        ...
                                        <?php foreach ($gen as $gen): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <?php
                                                    echo anchor("Products/ViewProductsEditForm/$gen->kwd", $edit, array('onClick' => "return confirm('Είστε σίγουρος για τις αλλαγές;;')"));
                                                    echo "<br>";
                                                    ?>
                                                    <?php echo anchor("Products/ViewProductsDelete/$gen->kwd", $delete, array('onClick' => "return confirm('Είστε σίγουρος για τη διαγραφή;;')")); ?>    
                                                </td>
                                            <?php endforeach; ?>
                                        </tr>
